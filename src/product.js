const works = [
    ...
    sections: [
      {
        ...
        alt: "PictIceロゴ画像",
        text: "2020年に開催予定であった東京オリンピック・パラリンピックを想定したコミュニケーションデザインの提案を行う課題で取り組んだ作品です。シンクロナイズドスイミングから名称が変更されたアーティスティックスイミングをより楽しんでもらうためのデザインとして「競技中の選手の形をデフォルメしたアイスキューブ」を提案しました。\n会場内で販売されているドリンクに入れることを想定し、手元でも競技を再現して楽しめ身近に感じることができることをコンセプトに制作しました。",
      },
      {
        title: "Website",
...

  {
    ...
    image: require("./assets/images/KOUSA_thumbnail.png"),
    alt: "KOUSAサムネイル画像",
    caption: "VRゲーム / 映像作品の展示・運営",
    sections: [
      {
        title: "About",
        img: require("./assets/images/KOUSA_website.png"),
        alt: "KOUSAウェブサイト画像",
        ...
        linktext: "KOUSA Web Site",
        link: "http://www.ne.senshu-u.ac.jp/~kousa2018/corporate/",
      },
      {
        title: "VR × 2D",
        img: "",
        alt: "",
        movie: "nMo65Vbw8kE",
        text: "実際に展示を行ったVRプレイヤーと2Dプレイヤーに分かれて戦う対戦型VRパズルゲーム「MagicBlock」では、Live2Dを使用したキャラクターアニメーションや広報・ルール説明用の映像制作を担当しました。",
      },
      {
        title: "Music × Movie",
        img: require("./assets/images/KOUSA_music.png"),
        alt: "映像作品画像",
        text: "キーボード・クラリネットの生演奏と映像を組み合わせた作品の展示も行いました。空間全体を演出することを目指し、二台のプロジェクターを使用して壁一面に映像を投影しながらリアルタイムに演奏と合わせられるよう制作しました。こちらの作品でも映像部分を担当しました。",
      }
    ]
  },

  {
    ...
    sections: [
      {
        title: "About",
        img: require("./assets/images/HABAKI_web.png"),
        alt: "鈨組ウェブサイト画像",
        text: "学生が立案したテーマを元に1年間かけて共同研究を行う「プロジェクト」という大学の講義にて取り組んでいた作品です。視聴者との双方向コミュニケーションを通して存在が変化していくVTuberというコンテンツを取り上げ、その技術と表現についての研究を行いました。また、実際にVTuberを制作しマルチメディア展開に挑戦しました。\nチーム内では主に映像編集・配信サポート・デザインを担当しています。",
        linktext: "鈨組 Official Site",
        link: "https://habakigumi.netlify.app/",
      },
      {
        title: "Movie & Live",
        img: "",
      ...
      {
        title: "Activity",
        img: require("./assets/images/HABAKI_book.png"),
        alt: "鈨組活動記録本画像",
        text: "およそ1年間の活動内容をまとめた記録本を制作しました。記事部分は本プロジェクトメンバー全員で担当し、デザインやレイアウト部分は私を含めた2名で制作を行いました。\n制作には主にAdobe InDesignとPhotoshopを使用し、記事構成や画像処理を担当しました。",
        linktext: "",
        link: "",
        DLtext: "制作記録本ダウンロード（PDF）",
        DLpath: "https://h0l1c.work/img/HabakiBook.pdf",
      },
    ]
  },

  {
    ...
    alt: "Re:HaRMoNIZEサムネイル画像",
    caption: "ライブシステム制作・ライブオペレーション",
    sections: [
      {
        title: "About",
...

  {
    ...
    alt: "SUISEI MUSIC 'POWER' LIVEサムネイル画像",
...

  {
    ...
    position: "映像制作",
    image: require("./assets/images/DigitalStars2021Reno_thumbnail.png"),
    alt: "DigitalStars2021Renoサムネイル画像",
    caption: "LyricMotion",
    sections: [
      {
        title: "About",
        img: require("./assets/images/Recreate.png"),
        alt: "Recreate!画像",
        movie: "",
        text: "2021/08/29にTwitchにて行われたクリプトン様主催のクロスカルチャーDJイベント「Digital Stars 2021」にて、NEXTLIGHT主催であるReno様のDJ Set演出をVirtualizeRealizeチームとして制作させて頂きました。\n Reno様の楽曲であるRecreate!とLightTheoryのリリックモーション制作を担当しました。",
        linktext: "TwitterURL",
        link: "https://twitter.com/reno_gtgtgt/status/1431935174527238150?s=20",
      },
    ]
  },

  {
    ...
    image: require("./assets/images/TC2WS_thumbnail.png"),
    alt: "TC2WSサムネイル画像",
    caption: "自主制作アプリケーション",
    sections: [
      {
        title: "About",
        img: require("./assets/images/TC2WS.png"),
        alt: "TC2WS画像",
        movie: "",
        text: "VirtualizeRealizeチームメンバーであるYothubaによって制作されたElectron製アプリケーション「TwitchComment2Websocket」（以下TC2WS）のデザイン及びcssコーディングを担当しています。\n「TC2WS」はTwitchのチャンネルURLを指定することでコメントをWebSocket経由でUnityなどの各種ソフトウェアに送ることができるデスクトップアプリケーションです。現在GitHubにて配布を開始しながら随時アップデートを行っています。",
        linktext: "実際に制作したアプリケーション",
        link: "https://github.com/Yothuba3/TwitchComment2Websocket",
      },
      {
        title: "Design",
        img: require("./assets/images/TC2WS_icon.png"),
        alt: "TC2WSデザインコンセプト画像",
        movie: "",
        text: "アイコンはアプリケーションの機能部分から「接続」「パイプライン」をモチーフにしつつ、左の赤い部分でCommentのCを右の青い部分で2(to)となっており両方を合わせることでWebSocketのWになるというデザインになっています。\nまた、全体的な配色はTwitchのテーマカラーに基づいて制作されている他、ユーザーが操作する部分は紫。結果が反映されるだけで操作できない部分は黒で統一し操作性を考慮しています。",
        linktext: "",
        link: "",
      },
    ]
