<template>
  <div class="topMenu">
    <a v-on:click="toggleClass" class="menuBtn" v-bind:class="{ 'btnActive' : isActive }">
      <span></span>
      <span></span>
    </a>

    <div class="menuContents" v-bind:class="{ 'menuActive' : isActive}">
      <ul class="iconList">
        <li>
      ...
      <ul class="linkList">
        <li>
          <a href="https://www.behance.net/H0L1C/projects" target="_blank" rel="noopener">
            <span class="GalleryLink">Gallery</span>
          </a>
        </li>
      </ul>
    </div>
...
.menuActive {
  ...
  -moz-filter: drop-shadow(1px 1px 5px rgba(0, 0, 0, 0.1));
  -ms-filter: drop-shadow(1px 1px 5px rgba(0, 0, 0, 0.1));
